from app.declaracao_hipo.PF.extracao_dec import *
import os
...
def obter_dados(screen_instance, _):
    try:
        ...
        placeholders = {
            ...
            "#RG_CLIENTE": screen_instance.rg.text,
            "#CIDADE_CLIENTE": screen_instance.cidade.text,
            "#SIGLA_ESTADO_CLIENTE": screen_instance.estado.text,
