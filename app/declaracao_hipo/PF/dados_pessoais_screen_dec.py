...
from app.declaracao_hipo.PF.funcoes_declaracao_PF import *
...
class DadosPessoaisPFScreen(Screen):
    def __init__(self, **kw):
        ...
        self.estado_civil = FocusSwitchingTextInput(hint_text="Digite o estado civil do cliente", multiline=False, size_hint_y=0.18)
