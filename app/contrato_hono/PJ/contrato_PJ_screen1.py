...
class ProcessoScreen(Screen):
    def __init__(self, **kwargs):
        ...
        nome_civil.add_widget(self.nome_cliente)
        ...
        cid_est_CONT_layout.add_widget(self.cidade_cliente)
