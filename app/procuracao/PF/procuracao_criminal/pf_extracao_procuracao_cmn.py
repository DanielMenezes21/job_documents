...
def processar_documento(caminho_modelo, nome_cliente, cpf, cidade_cliente, 
                        sigla_estado_cliente, inscrita_o, nacionalidade, poderes, 
                        nome_arquivo, advogado_oab, endereço, cep, estado_civil, rg, profissao):
    ...
    placeholders = {
        ...
        "#SIGLA_ESTADO_CLIENTE": sigla_estado_cliente,
