...
class PesquisaApp(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.rg_input = TextInput(hint_text="RG", multiline=False)
    ...
    def atualizar_lista(self, instance, value):
        ...
        for nome, cpf, rg in buscar_pessoas_por_nome(self.pesquisa_input.text.strip()):
    ...
    def preencher_campos(self, texto):
        ...
        for nome_bd, cpf_bd, rg_bd in buscar_pessoas_por_nome(cpf):
            if cpf_bd == cpf:
