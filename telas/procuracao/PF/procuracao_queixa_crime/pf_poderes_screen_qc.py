...
from telas.procuracao.PF.procuracao_queixa_crime.pf_texto_poderes import TEXTOS_PODERES, ADVOGADO_OAB
...
class PFPoderesQCScreen(Screen):
    def __init__(self, **kwargs):
        super(PFPoderesQCScreen, self).__init__(**kwargs)
