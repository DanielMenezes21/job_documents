...
from telas.procuracao.PJ.procuracao_queixa_crime.pj_texto_poderes_qc import TEXTOS_PODERES, ADVOGADO_OAB
from telas.procuracao.PJ.procuracao_queixa_crime.pj_extracao_procuracao_qc import processar_documento, formatar_data
