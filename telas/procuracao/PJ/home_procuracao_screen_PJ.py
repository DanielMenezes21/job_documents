...
class HomeProcuracaoPJScreen(Screen):
    def __init__(self, **kwargs):
        super(HomeProcuracaoPJScreen, self).__init__(**kwargs)
        ...
        btn_procuracao = Button(
            ...
            on_press=self.ir_para_procuracao_cmn_pj
        )
        ...
        btn_processo = Button(
            ...
            size_hint=(None, None),
            size=(230, 50),
            pos_hint={"center_x": 0.5, "top": 0.3},  # Ajuste na posição do botão
            on_press=self.ir_para_procuracao_qc_pj
        )
    ...
    def ir_para_procuracao_qc_pj(self, instance):
        """
        Função para ir até a tela de ProcuracaoScreen
        """
        self.manager.current = "procuracao_queixa_crime_pj_screen"
        
    def ir_para_procuracao_cmn_pj(self, instance):
        """
