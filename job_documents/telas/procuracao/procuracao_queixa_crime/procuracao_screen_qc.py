...
from telas.procuracao.procuracao_queixa_crime.funcoes_procuracao_qc import on_nacionalidade_change, ir_para_poderes, ir_para_procuracao

class ProcuracaoQCScreen(Screen):
