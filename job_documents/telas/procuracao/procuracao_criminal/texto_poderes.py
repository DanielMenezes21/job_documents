...
TEXTOS_PODERES = {
    "Modelo 1 - Poderes": (
        ...
        "inclusive: Propor ações, contestar, recorrer, desistir, transigir, firmar acordos, reconhecer pedidos, interpor recursos e atuar em audiências;"
        "Requerer, obter e retirar certidões, documentos, prontuários médicos, laudos médicos, e quaisquer informações necessárias junto a órgãos públicos ou privados;"
        "Obter certidões junto a cartórios judiciais, extrajudiciais e demais repartições públicas;"
