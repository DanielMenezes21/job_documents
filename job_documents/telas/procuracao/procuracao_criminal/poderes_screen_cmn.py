...
from telas.procuracao.procuracao_criminal.texto_poderes_cmn import TEXTOS_PODERES_A, ADVOGADO_OAB
...
class PoderesCriminalScreen(Screen):
    def __init__(self, **kwargs):
        super(PoderesCriminalScreen, self).__init__(**kwargs)
