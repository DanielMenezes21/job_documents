...
from telas.procuracao.procuracao_criminal.funcoes_procuracao_cmn import on_nacionalidade_change, ir_para_poderes, ir_para_procuracao

class ProcuracaoCriminalScreen(Screen):
